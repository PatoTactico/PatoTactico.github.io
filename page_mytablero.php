    ...
    <div class="header-content">
        ...
        <div class="menu" id="show-menu">
            ...
            <nav>
                ...
                <li class="menu-selected"><a href="page_mytablero.php" class="text-menu-selected"><i class="fa-solid fa-table"></i> MyTablero</a></li>
    ...
    <div class="container-all" id="move-content">
        ...
        <div class="container-content_01">
            ...
            <div class="container-aside">
                ...
                <p>Muestra un tablero con las tareas de los alumnos, título de la tarea, descripcion, fecha y hora, y el estado de la tarea. </p>
